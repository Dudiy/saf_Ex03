...
rem tzvi: on my computer this is:
rem tzvi:  "C:\Program Files (x86)\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe"
rem set VS_HOME=C:\Program Files (x86)\Microsoft Visual Studio 10.0
echo "=============================="
set VS_HOME=E:\Programs\Visual Studio
